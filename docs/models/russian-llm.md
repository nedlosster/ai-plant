...
## Закрытые российские LLM (для сравнения)

Эти модели недоступны для self-hosting, но задают планку для open-source finetune'ов:

- **GigaChat Ultra** (Сбер, март 2026) -- флагман с reasoning-режимом, MoE-архитектура, мультимодальность (после GigaChat 2.0 в 2025)
- **YandexGPT / Alice AI** (Яндекс, февраль-март 2026) -- новое семейство Alice, инференс в 2.5 раза быстрее YandexGPT 4 Pro, режим Chain-of-Reasoning (аналог o3, DeepSeek R1), доступ через Yandex Cloud AI Studio

Open-source finetune'ы (Saiga, T-pro, Vikhr) остаются единственным вариантом для запуска на собственной платформе без зависимости от облака.
