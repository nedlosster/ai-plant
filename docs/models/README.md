...
| diffusion | 12B | FLUX.1-schnell | [flux](families/flux.md#schnell) | [images](images.md) | `comfyui/start.sh` | ~7 GiB |
| diffusion | 12B | FLUX.1-dev | [flux](families/flux.md#dev) | [images](images.md) | `comfyui/start.sh` | ~13 GiB |
