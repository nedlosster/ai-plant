...
На Strix Halo основной coding стек -- [Qwen3-Coder Next](families/qwen3-coder.md) (70.6% SWE-bench) и [Devstral 2](families/devstral.md) (72.2%). Closed-source frontier -- на 10-21 п.п. выше по SWE-bench. Зачем об этом знать:

1. **Benchmark-ориентир**: понимать куда движется индустрия и где потолок. Devstral 2 72.2% vs Claude Mythos 93.9% -- gap **21.7 п.п.**, значительный для сложных задач
...
### Claude Opus 4.5 / Sonnet 4.5 / Opus 4.6 / Sonnet 4.6 (Anthropic)

**Тип**: проприетарная (архитектура не раскрыта)
**Доступ**: API (Opus $5/1M in, $25/1M out; Sonnet $3/$15), Claude Code $20-200/мес
**SWE-bench Verified**: Opus 4.5 80.9%, Mythos Preview 93.9%
**Контекст**: 200K (standard), **1M** (Opus 4.6 / Sonnet 4.6, Max plan)
...
- Opus 4.6 -- это текущая "наилучшая" в Claude Code Max plan ($200/мес)
...
**Gap между best open (72.2%) и best closed non-preview (85.0%)**: 12.8 п.п.
...
|--------|-------------|----------------------|
| **Качество на сложных задачах** | 85-94% SWE-bench | 70-72% SWE-bench |
