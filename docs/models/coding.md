...
- **[Qwen3.6-Plus](families/qwen36.md)** (Alibaba, 2 апреля 2026) -- agentic coding уровня Claude 4.5 Opus, 1M контекст, native function calling, multimodal. **SWE-V 78.8%**, **Terminal-Bench 2.0 61.6%** (vs Claude Opus 4.6 59.3%). API-only через Alibaba Cloud Model Studio. Open-варианты обещаны "в developer-friendly размерах" -- ждём 30-122B диапазон в Q2-Q3, по аналогии с Qwen3.5.
