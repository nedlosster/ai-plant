...
- **[Kimi K2.6](families/kimi-k25.md)** (Moonshot, 20-22 апреля 2026) -- 1T MoE, Apache 2.0, **SWE-Bench Pro 58.6%** (новый лидер open-weight), HLE 54.0%, SWE-bench Multilingual 76.7%. Четыре варианта: Instant / Thinking / Agent / Agent Swarm. ~240+ GB Q4, через API. См. [news.md](news.md).
...
| **Kimi K2.6 (open Apache 2.0)** | -- | **58.6%** ⭐ | 20-22 апр 2026 |
...
- **[Kimi K2.6](families/kimi-k25.md)** (Moonshot AI, 20-22 апреля 2026) -- 1T MoE, Apache 2.0. SWE-Bench Pro **58.6%** (SOTA среди open-weight), HLE 54.0%, SWE-bench Multilingual 76.7%. Четыре варианта (Instant / Thinking / Agent / **Agent Swarm** -- native multi-agent). Не помещается, через API.
