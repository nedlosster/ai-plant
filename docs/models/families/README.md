...
Статьи направлений ([`../coding.md`](../coding.md), [`../llm.md`](../llm.md), [`../vision.md`](../vision.md) и т.д.) содержат только сравнительные таблицы и "выбор под задачу" со ссылками сюда.
