...
**Топ-result платформы Strix Halo** (Qwen3.6-35B-A3B text-only full): **65.6%** pass_rate_2. Текущий running Qwen3.5-122B-A10B: **75.9%** на 116/195 задач (running 2026-04-29).

**Разрыв до frontier**: ~14-24pp от Opus 4.5/4.6/4.7. Сопоставимо с DeepSeek V3.2-Exp (74.2%) и o3 base (76.9%) -- то есть Strix Halo попадает в **mid-tier frontier zone**, превосходит Opus 4 (72.0%) на ~4pp при нулевой стоимости и полной приватности.
