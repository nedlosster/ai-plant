...
| Модель | Smoke (≤50 задач) | Full 225 | Дата smoke | Дата full | Note |
|--------|-------------------|----------|------------|-----------|------|
| **Qwen3.6-35B-A3B** (Q4_K_M) | **35.0%** single-shot на 20 задачах (clean ✓, no rust) | -- | 2026-04-26 (clean) | -- | ⭐ best quality |
| **Qwen3-Coder 30B-A3B** (Q4_K_M) | **15.0%** single-shot на 20 задачах (clean ✓, no rust) | -- | 2026-04-26 | -- | ⭐ best speed (17 sec/case) |
| Qwen3-Coder Next 80B-A3B (Q4_K_M) | 36.7% / 46.7% на 30 задачах (прерван) | -- | 2026-04-26 | -- | прерван retry-loop |
