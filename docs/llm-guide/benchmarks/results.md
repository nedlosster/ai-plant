...
|--------|-------------------|---------------------------|------------|-----------|------|
| **Qwen3.6-35B-A3B (text-only)** (Q4_K_M) | 30.0% / **70.0% (--tries 2)** на 20 задачах ✅ | -- | 2026-04-27 | -- | ⭐⭐ **best quality** (рекорд платформы, +40pp retry) |
...
**По языкам**: точная per-language разбивка недоступна (финальный YAML обрезан после 178), целевой набор: cpp 26, go 39, java 47, javascript 49, python 34
