...
- **Альтернативы (CLI)**: [aider](aider.md), [qwen-code](qwen-code.md), [claude-code](claude-code/README.md) для commercial
...
- **Платформа**: [coding.md](../../models/coding.md), пресеты [`scripts/inference/vulkan/preset/qwen-coder-next.sh`](../../../scripts/inference/vulkan/preset/qwen-coder-next.sh)
