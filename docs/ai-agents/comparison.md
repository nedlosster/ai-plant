...
| 3 | [Claude Code](agents/claude-code.md) | 55.5% | **95.0%** | 38.6% | 280 сек | 350K |
...
- **[Claude Code](agents/claude-code.md)** -- лучший frontend (95%), но backend тянет вниз
...
|-------|--------|--------|-----------|
| [Claude Code](agents/claude-code.md) | Opus 4.6 (Max) | 300-500K | $3-8 |
...
| Тип | Агенты |
|-----|--------|
| Anthropic-привязанные | [Claude Code](agents/claude-code.md) |
...
| **CLI + IDE + Web** | [Claude Code](agents/claude-code.md), Amazon Q |
...
| Поддержка | Агенты |
|-----------|--------|
| **Built-in multi-agent** | [Claude Code](agents/claude-code.md) (sub-agents), [Kilo Code](agents/kilo-code.md) (Orchestrator) |
...
| MCP | Агенты |
|-----|--------|
| **Зрелая экосистема** | [Claude Code](agents/claude-code.md) (создатели стандарта) |
...
| Multi-agent орчестрация без танцев | [Kilo Code](agents/kilo-code.md) Orchestrator или [Claude Code](agents/claude-code.md) |
...
| Best frontend score | [Claude Code](agents/claude-code.md) (95%) |
...
| **$100-200/мес** | [Claude Code](agents/claude-code.md) Max ($200) |
| **$300+/мес** | [Claude Code](agents/claude-code.md) + Codex |
