...
**Применение 2026-04-26**: убрана строка `--cache-reuse 256` из обоих пресетов. В header-комментариях зафиксировано почему не используется и ссылка на U-001 (PR 13194) для отслеживания.
