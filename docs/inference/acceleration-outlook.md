...
На апрель 2026:
- **Lemonade Server** ([AMD](https://www.amd.com/en/developer/resources/technical-articles/2026/lemonade-for-local-ai.html)) -- unified API для GPU + NPU
...
- OpenAI-compatible API через Lemonade -- можно подключить к [opencode](../ai-agents/agents/opencode.md)
